<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="modelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="模型内容" align="center" prop="content" />
...
<script>
import { listModel, getModel, delModel, addModel, updateModel } from "@/api/chat/model";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('chat/model/export', {
        ...this.queryParams
